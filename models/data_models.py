...
# ─────────────────────────────────────────────────────────────────────────────
# Step 1.5 — API Generation (LLM output for DEFINE_APIS)
# ─────────────────────────────────────────────────────────────────────────────

@dataclass
class APISpec:
    """
    Generated API specification for a single tool.
    Extracted from LLM-generated DEFINE_APIS block.
    """
    name: str  # API name (from tool_hint or tool.name)
    spl_text: str  # Full DEFINE_API block generated by LLM
    input_params: list[dict]  # [{"name": str, "type": str, "required": bool}]
    output_params: list[dict]  # [{"name": str, "type": str}]
